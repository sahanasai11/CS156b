...
# making 6 separate sub-arrays splitting the training lables
y_train_support = []
y_train_cardio = []
y_train_p = []
y_train_fracture = []
...
# SUPPORT DEVICE LABELS: -1 to 0 (ending with all 0 and 1)
...
print('binary support: total, num 0, num 1, num0 + num1:', len(binary_support), num0, num1, num0 + num1)
