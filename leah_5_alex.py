# 5 model classifier all using alexnet
import pandas as pd
import numpy as np
...
# subset 10,000 training data ( 100 x 100 )
TRAIN_PATH = '/central/groups/CS156b/teams/clnsh/subset_compressed_data10/subset_'
...
while i < len(y_train):
    ...
    y_train_p.append(y_train[i][9:12]) # 0-indexed 9th - 11th element
    y_train_fracture.append(y_train[i][12]) # 0-indexed 12th element
    
    y_train_other_curr = np.concatenate(([y_train[i][0]], y_train[i][3:9])) # remaining 7
