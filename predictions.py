# cleaned up the code, created paths for subset and big data
...
# forming labels of trainng data
y_train = []
...
print('train tensor of tensor created')

test_tensor_of_tensors = tf.convert_to_tensor(tensor_test)
print('test tensors of tensors created')
